...
public class beerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("crash", false)) {
            Intent n = new Intent(beerActivity.this, firstActivity.class);
            startActivity(n);
        }
        ...
        AuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser == null) {
                    // User is signed out
                    Toast.makeText(beerActivity.this,"Please Sign In or Sign Up",Toast.LENGTH_LONG).show();

                    Intent i = new Intent(beerActivity.this,firstActivity.class);
                    startActivity(i);
                }
            }
        };
        ...
        layoutManager = new LinearLayoutManager(beerActivity.this);
        ...
        if (ebu== null){
            Toast.makeText(beerActivity.this,"Please Select Store",Toast.LENGTH_LONG).show();

            Intent intent = new Intent(beerActivity.this,outletActivity.class);
            startActivity(intent);
        }else {
            String store=ebu.trim();
            db=FirebaseDatabase.getInstance().getReference("lavia/Nairobi/"+store+"/Liquor/Beer/");
        }

        Toast.makeText(beerActivity.this,ebu,Toast.LENGTH_LONG).show();

        progressDialog=ProgressDialog.show(this,"Chill","Loading");
        firebaseClient helper = new firebaseClient(beerActivity.this, db, mRecyclerView);
        ...
        navigationView.setNavigationItemSelectedListener(beerActivity.this);
...
progressDialog.cancel();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            startActivity(new Intent(beerActivity.this, firstActivity.class)); //Go back to home page
            finish();
