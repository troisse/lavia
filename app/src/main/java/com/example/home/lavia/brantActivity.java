...
public class brantActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    AuthListener = new FirebaseAuth.AuthStateListener() {
        ...
        public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
            ...
            if (firebaseUser == null) {
                // User is signed out
                Toast.makeText(brantActivity.this,"Please Sign In or Sign Up",Toast.LENGTH_LONG).show();
    ...
    mRecyclerView.setLayoutManager(layoutManager);
        ...
        if (ebu== null){
        Toast.makeText(brantActivity.this,"Please Select Store",Toast.LENGTH_LONG).show();
