...
public class garActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser == null) {
                    // User is signed out
                    Toast.makeText(garActivity.this,"Please Sign In or Sign Up",Toast.LENGTH_LONG).show();
        ...
        if (ebu == null){
            Toast.makeText(garActivity.this,"Please Select Store",Toast.LENGTH_LONG).show();
