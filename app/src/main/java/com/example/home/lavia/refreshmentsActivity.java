...
public class refreshmentsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser == null) {
                    // User is signed out
                    Toast.makeText(refreshmentsActivity.this,"Please Sign In or Sign Up",Toast.LENGTH_LONG).show();
        ...
        if (ebu== null){
            Toast.makeText(refreshmentsActivity.this,"Please Select Store",Toast.LENGTH_LONG).show();
