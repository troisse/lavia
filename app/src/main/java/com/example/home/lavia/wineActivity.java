...
public class wineActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("crash", false)) {
            Intent n = new Intent(wineActivity.this, firstActivity.class);
            startActivity(n);
        }
        ...
        AuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser == null) {
                    // User is signed out
                    Toast.makeText(wineActivity.this,"Please Sign In or Sign Up",Toast.LENGTH_LONG).show();

                    Intent i = new Intent(wineActivity.this,firstActivity.class);
                    startActivity(i);
                }
            }
        };
        ...
        layoutManager = new LinearLayoutManager(wineActivity.this);
        ...
        if (ebu== null){
            Toast.makeText(wineActivity.this,"Please Select Store",Toast.LENGTH_LONG).show();

            Intent intent = new Intent(wineActivity.this,outletActivity.class);
            startActivity(intent);
        }else {
            String store=ebu.trim();
            db=FirebaseDatabase.getInstance().getReference("lavia/Nairobi/"+store+"/Liquor/Wine/");

        }

        progressDialog=ProgressDialog.show(this,"Chill","Loading");
        firebaseClient helper = new firebaseClient(wineActivity.this, db, mRecyclerView);
        ...
        navigationView.setNavigationItemSelectedListener(wineActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            startActivity(new Intent(wineActivity.this, firstActivity.class)); //Go back to home page
            finish();
