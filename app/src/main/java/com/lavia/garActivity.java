...
public class garActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("crash", false)) {
            Intent n = new Intent(garActivity.this, firstActivity.class);
            startActivity(n);
        }
        ...
        AuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser == null) {
                    // User is signed out
                    Toast.makeText(garActivity.this,"Please Sign In or Sign Up",Toast.LENGTH_SHORT).show();

                    Intent i = new Intent(garActivity.this,firstActivity.class);
                    startActivity(i);
                }
            }
        };
        ...
        layoutManager = new LinearLayoutManager(garActivity.this);
        ...
        if (ebu == null){
            Toast.makeText(garActivity.this,"Please Select Store",Toast.LENGTH_SHORT).show();

            Intent intent = new Intent(garActivity.this,outletActivity.class);
            startActivity(intent);
        }else {
            String store=ebu.trim();
            db=FirebaseDatabase.getInstance().getReference("lavia/Nairobi/"+store+"/Liquor/Gin/");

        }

        progressDialog=ProgressDialog.show(this,"Chill","Loading");
        firebaseClient helper = new firebaseClient(garActivity.this, db, mRecyclerView);
        ...
        navigationView.setNavigationItemSelectedListener(garActivity.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.gar, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            startActivity(new Intent(garActivity.this, firstActivity.class)); //Go back to home page
            finish();
