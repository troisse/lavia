...
public class refreshmentsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("crash", false)) {
            Intent n = new Intent(refreshmentsActivity.this, firstActivity.class);
            startActivity(n);
        }
        ...
        AuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser == null) {
                    // User is signed out
                    Toast.makeText(refreshmentsActivity.this,"Please Sign In or Sign Up",Toast.LENGTH_SHORT).show();

                    Intent i = new Intent(refreshmentsActivity.this,firstActivity.class);
                    startActivity(i);
                }
            }
        };
        ...
        layoutManager = new LinearLayoutManager(refreshmentsActivity.this);
        ...
        if (ebu== null){
            Toast.makeText(refreshmentsActivity.this,"Please Select Store",Toast.LENGTH_SHORT).show();

            Intent intent = new Intent(refreshmentsActivity.this,outletActivity.class);
            startActivity(intent);
        }else {
            String store=ebu.trim();
            db=FirebaseDatabase.getInstance().getReference("lavia/Nairobi/"+store+"/Liquor/Refreshments/");
        }

        progressDialog=ProgressDialog.show(this,"Chill","Loading");
        firebaseClient helper = new firebaseClient(refreshmentsActivity.this, db, mRecyclerView);
        ...
        navigationView.setNavigationItemSelectedListener(refreshmentsActivity.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.refreshments, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            startActivity(new Intent(refreshmentsActivity.this, firstActivity.class)); //Go back to home page
            finish();
